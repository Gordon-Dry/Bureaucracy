...
namespace Bureaucracy
{
    public class BudgetReport : Report
    {
        ...
        {
            ReportBuilder.Clear();
            ReportBuilder.AppendLine("Gross Budget: " + Utilities.GetGrossBudget());
            ReportBuilder.AppendLine("Staff Wages: " + Costs.GetWageCosts());
            ReportBuilder.AppendLine("Facility Maintenance Costs: " + Costs.GetFacilityMaintenanceCosts());
            ...
            double netBudget = Utilities.GetNetBudget("Budget");
